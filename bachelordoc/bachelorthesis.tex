...
%----------------- PDF CONFIG ----------------- %
\pdfinfo{    
     /Title     (Terminplaner für Arztpraxen) 
     /Subject   (Bachelorhthesis )    
     /Author    (Simon, Vince, Florian) 
     /Keywords  (Master, Dokumentation, HSRM)      
} 

\title{Terminplaner für Arztpraxen}
\author{Simon, Vince, Florian}
\date{14.02.2021}
